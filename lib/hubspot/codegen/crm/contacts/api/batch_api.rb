  ...
  module Crm
    module Contacts
      class BatchApi
        ...
        # @param [Hash] opts the optional parameters
        # @return [BatchResponseSimplePublicObject]
        def update(batch_inpuct_simple_public_object_batch_input, opts = {})
        ...
        # @param [Hash] opts the optional parameters
        # @return [BatchResponseSimplePublicObject]
        def upsert(batch_input_simple_public_object_batch_input, opts = {})
          data, _status_code, _headers = upsert_with_http_info(batch_input_simple_public_object_batch_input, opts)
          data
        end
        ...
        # @param [Hash] opts the optional parameters
        # @return [Array<(BatchResponseSimplePublicObject, Integer, Hash)>] BatchResponseSimplePublicObject data, response status code and response headers
        def upsert_with_http_info(batch_input_simple_public_object_batch_input, opts = {})
          if @api_client.config.debugging
            @api_client.config.logger.debug 'Calling API: BatchApi.upsert ...'
          end
          # verify the required parameter 'batch_input_simple_public_object_batch_input' is set
          if @api_client.config.client_side_validation && batch_input_simple_public_object_batch_input.nil?
            fail ArgumentError, "Missing the required parameter 'batch_input_simple_public_object_batch_input' when calling BatchApi.upsert"
          end
          # resource path
          local_var_path = '/crm/v3/objects/contacts/batch/upsert'
